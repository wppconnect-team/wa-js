 ...
 */
export declare interface NetworkStatusModel extends ModelProxy<
  Props,
  Session,
  Derived
> {}
...
export declare class NetworkStatusModel extends Model<MuteCollection> {
  constructor(
    proterties?: ModelPropertiesContructor<NetworkStatusModel>,
    options?: ModelOptions
  );
  waitIfOffline(options: { signal: AbortSignal }): Promise<void>;
  checkOnline(options: { signal: AbortSignal }): Promise<void>;
}
